...
# FedAvg esxperiments in Figure 4, 9 of (McMahan et al., 2016)
## IID split
python3 main.py \
    --exp_name FedAvg_CIFAR10_CNN_IID --seed 42 --device cpu \
    --dataset CIFAR10 \
...
python3 main.py \
    ...
    --optimizer SGD --lr 0.5 --lr_decay 0.99 --lr_decay_step 1 --criterion CrossEntropyLoss