...
do
    ...
    do
        ...
        python3 main.py \
            --exp_name "Sent140_FedAvgHedge_${a} (${s})" --seed $s --device cuda:0 \
        ...
        --split_type pre --rawsmpl 0.01 --test_size 0.2 \
        --model_name Sent140LSTM --embdedding_size 300 --hidden_size 256 --num_layers 2 \
...
python3 main.py \
    ...
    --optimizer SGD --lr 0.0003 --lr_decay 0.9995 --lr_decay_step 1 --criterion BCEWithLogtisLoss