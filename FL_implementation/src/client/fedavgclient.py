...
class FedAvgClient(BaseClient):
    def __init__(self, args, training_set, test_set):
        ...
        self.train_loader = self._create_dataloader(self.training_set, shuffle=not self.no_shuffle)
    ...
    def update(self):
        mm = MetricManager(self.args.eva_metrics)
        self.model.train()
