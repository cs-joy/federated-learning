...
class Heart(Dataset):
    ...
    def __getitem__(self, index):
        inputs, targets = torch.tensor(self.inputs[index]), torch.tensor(self.targets[index])
...
def fetch_heart(args, root, seed, test_size):
    ...
    def _munge_and_split(root, hospital, seed, test_size):
        ...
        to_drop = [
            ...
            11, # number of major vessels (0-3) colored by flouroscopy
    ...
    logger.info(f'[LOAD] [HEART] ...munged and splitted dataset!')
