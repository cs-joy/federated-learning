...
def preprocess(root):
    ...
    def _convert_to_json(path, raw_all, indices):
        def _cleanse(df):
            ...
            df = df.apply(lambda x: re.sub(r"(.)\1\1+", str(x).strip()))
        ...
        def _line_to_indices(line, word2id, max_words= 25):
            ...
            returns a list of containing indices of the firs `max_words` words.
            ...
            Args:
                ...
                word2id: dictionary with string word as keyys and int indices as values
